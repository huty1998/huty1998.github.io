...
<img src="https://labuladong.github.io/algo/images/状态压缩/1.jpeg" width="400">

这就叫和 `dp[i][j]` 相邻，反正你计算 `dp[i][j]` 只需要这三个相邻状态，其实根本不需要那么大一个二维的 dp table 对不对？**空间压缩的核心思路就是，将二维数组「投影」到一维数组**：

<img src="https://labuladong.github.io/algo/images/状态压缩/2.jpeg" width="400">
...
<img src="https://labuladong.github.io/algo/images/状态压缩/3.jpeg" width="400">
...
<img src="https://labuladong.github.io/algo/images/状态压缩/4.jpeg" width="400">
