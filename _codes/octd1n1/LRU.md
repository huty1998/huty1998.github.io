...
<img src="https://labuladong.github.io/algo/images/LRU算法/1.jpg" width="400">

但是这时候如果我访问了一下「设置」界面，那么「设置」就会被提前到第一个，变成这样：

<img src="https://labuladong.github.io/algo/images/LRU算法/2.jpg" width="400">

假设我的手机只允许我同时开 3 个应用程序，现在已经满了。那么如果我新开了一个应用「时钟」，就必须关闭一个应用为「时钟」腾出一个位置，关那个呢？

按照 LRU 的策略，就关最底下的「手机管家」，因为那是最久未使用的，然后把新开的应用放到最上面：

<img src="https://labuladong.github.io/algo/images/LRU算法/3.jpg" width="400">
...
<img src="https://labuladong.github.io/algo/images/LRU算法/4.jpg" width="400">
...
<img src="https://labuladong.github.io/algo/images/LRU算法/put.jpg" width="400">
